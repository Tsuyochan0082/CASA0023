...
::: {.callout-note}
### Figure 1: Beirut Change Map / Workflow Output
(ここにベイルートのチェンジマップ、または実習コードの出力を挿入)
:::
...
::: {.callout-note}
### Figure 2: Suzu Change Map
(ここに珠洲市のチェンジマップを挿入)
:::

::: {.callout-note}
### Figure 3: Building-level Suzu Map
(ここに珠洲市の建物レベルの集計マップを挿入。Figure 2と比較できるように配置)
:::
